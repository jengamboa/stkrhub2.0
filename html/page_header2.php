					...
					<ul class="nav navbar-nav menu_nav ml-auto">
						...
						<li class="nav-item submenu dropdown">
							...
							<ul class="dropdown-menu">
								<li class="nav-item">
									<a class="nav-link" href="create_game_page.php">Create Game</a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
									<a class="nav-link" href="canceled_built_games_page.php">Canceled Games</a>
								<li class="nav-item">
									<a class="nav-link" href="approved_built_games_page.php">Approved Games</a>
								<li class="nav-item">
									<a class="nav-link" href="purchased_built_games_page.php">Purchased Games</a>
								<li class="nav-item">
									<a class="nav-link" href="published_built_games_page.php">Published Games</a>
								</li>
						</li>
					</ul>
					</li>
