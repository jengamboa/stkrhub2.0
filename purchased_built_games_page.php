...
<ul>
    <?php while ($game = mysqli_fetch_assoc($result)) { ?>
        <li>
            <p>Built Game ID: <?php echo $game['built_game_id']; ?></p>
            <p>Game ID: <?php echo $game['game_id']; ?></p>
            <p>Name: <?php echo $game['name']; ?></p>
            <p>Description: <?php echo $game['description']; ?></p>
            <p>Creator ID: <?php echo $game['creator_id']; ?></p>
            <p>Build Date: <?php echo $game['build_date']; ?></p>
            <p>Is Pending: <?php echo ($game['is_pending'] == 1 ? 'Yes' : 'No'); ?></p>
            <p>Is Canceled: <?php echo ($game['is_canceled'] == 1 ? 'Yes' : 'No'); ?></p>
            <p>Is Approved: <?php echo ($game['is_approved'] == 1 ? 'Yes' : 'No'); ?></p>
            <p>Is Purchased: <?php echo ($game['is_purchased'] == 1 ? 'Yes' : 'No'); ?></p>
            <p>Is Published: <?php echo ($game['is_published'] == 1 ? 'Yes' : 'No'); ?></p>
