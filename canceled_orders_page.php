...
$query = "SELECT order_id, published_game_id, built_game_id, added_component_id FROM orders WHERE user_id = '$user_id' AND is_canceled = 1";
            ...
            <ul>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <li>
                        ...
                        <input type="hidden" name="published_game_id" value="<?php echo $row['published_game_id']; ?>">

                        <button type="submit" name="cancel">Rate</button>
                    </li>
                <?php endwhile; ?>
            </ul>
        <?php else: ?>
