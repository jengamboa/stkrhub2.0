...
<body>
    <div class="panel">
        <h2>Cart</h2>
        <form action="echo_cart_id.php">
            <?php
            while ($item = mysqli_fetch_assoc($result_cart)) {
                echo '<div class="cart-item">';
                echo '<p><input type="checkbox" name="selectedItems[]" value="' . $item['cart_id'] . '"> Item ID: ' . $item['cart_id'] . '</p>';
            ...
            <button type="submit" name="deleteSelected">Delete Selected</button>
        </form>
