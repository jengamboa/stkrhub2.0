...
$sqlUniqueOrderDates = "SELECT DISTINCT unique_order_group_id FROM orders WHERE to_ship = 1";
                    ...
                    <div class="card rounded-3 mb-4 p-0 custom-shadow" style="background-color: #17172b; padding: 0.1rem;">
                        ...
                        <div class="card-body p-0" style="background-color: #272a4e;">
                            <div class="row d-flex justify-content-between align-items-center ">
                                ...
                                $sqlAll = "SELECT * FROM orders WHERE unique_order_group_id = $unique_order_group_id AND to_ship = 1";
