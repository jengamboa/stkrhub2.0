$(document).ready(function(){
  ...
  FJS.addCriteria({field: 'stars', ele: '#stars_filter', type: 'range'});
...
function initSliders(){
  ...
  $("#stars_slider").slider({
    ...
    range:true,
    slide: function( event, ui ) {
      $("#stars_range_label" ).html(ui.values[ 0 ] + ' stars. - ' + ui.values[ 1 ] + ' stars.');
      $('#stars_filter').val(ui.values[0] + '-' + ui.values[1]).trigger('change');
    }
  });
